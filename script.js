    ...
    try {
      ...
      cardContainer.innerHTML += `<div data-folder="${folder}" class="card">
        ...
        <svg
              ...
              <img 
  src="songs/${folder}/${json.image || "cover.jpg"}" 
  alt="Album Art" 
  onerror="this.onerror=null; this.src='default.jpg';"
/>
              <h4>${json.title || "Untitled Album"}</h4>
              <p>${json.Description || "No description available"}</p>
              </div>`;
    } catch (err) {
...
async function main() {
  ...
  // Add An Event Listener to the close Hamburger Menu
